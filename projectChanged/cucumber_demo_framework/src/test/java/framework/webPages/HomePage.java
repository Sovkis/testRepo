...
public class HomePage extends BasePage{
	...
	private By loginDarkSky = By.xpath("//a[contains(text(),'Log In')]");
	...
	public void clickOnApi() {clickOn(darkSkyAPI);}

	public void clickOnLogin() { clickOn(loginDarkSky);}

	public void clickOnExpandWeather() { clickOn(expandWeather);}
}
